...
const Body_3 = () => {
    ...
    const [csbackgroundColor, setcsBackgroundColor] = useState('linear-gradient(111deg, #142323, #142323)');

    const [algomarginTop, setalgoMarginTop] = useState('220px');
    const [algocontainerMarginTop, setalgoContainerMarginTop] = useState('220px');
    const [algobackgroundColor, setalgoBackgroundColor] = useState('linear-gradient(111deg, #142323,#142323)');
    ...
    const handlecsCoverClick = () => {
        if (csmarginTop === '220px') {
            ...
            setcsBackgroundColor('linear-gradient(111deg, #142323, #142323)');
        }
    };
